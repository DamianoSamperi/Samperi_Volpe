...
def registrazione():
    ...
    url='http://user-controller-service:5000/registrazione'
...
def tratta():
    ...
    try:
        budget=int(input("inserisci il tuo budget: "))
            ...
            main()
    url='http://user-controller-service:5000/Insert_tratta'
...
def aeroporto():
    ...
    try:
        budget=int(input("inserisci il tuo budget: "))
            ...
            print("Inserisci un numero valido.")
            main()
    url='http://user-controller-service:5000/Insert_aeroporto'
...
def disiscrivi_tratta():
    ...
    origine=input("inserisci aeroporto origine: ")
    destinazione=input("inserisci aeroporto destinazione: ")
    url='http://user-controller-service:5000/Disiscrizione_tratta'
...
def disiscrivi_aeroporto():
    email=input("\ninserisci la tua email: ")
    origine=input("inserisci aeroporto origine: ")
    url='http://user-controller-service:5000/Disiscrizione_aeroporto'
